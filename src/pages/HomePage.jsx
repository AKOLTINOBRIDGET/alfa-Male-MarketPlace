...
const HomePage = () => {
  ...
  return (
    <div className="-mt-20"> {/* Offset navbar padding for full screen hero */}
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-20">
          <motion.span 
            ...
            className="text-gold-500 font-medium tracking-[0.2em] uppercase text-sm mb-4 block"
          >
            ...
            {categories.map((category, index) => (
              ...
              >
                <Link 
                  ...
                  className="group block relative h-96 overflow-hidden rounded-2xl border border-white/5"
                >
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-8 z-20 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <span className="text-gold-500 font-medium uppercase tracking-widest text-sm flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
      ...
      {/* Experience Strip */}
      <section className="py-20 bg-dark-100 border-t border-b border-white/5">
        <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
          <h2 className="text-3xl font-serif text-gold-500 mb-6">The Alfa Experience</h2>
